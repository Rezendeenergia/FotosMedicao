...
def resize_photo(img_bytes: bytes, w_cm=TARGET_W_CM, h_cm=TARGET_H_CM) -> bytes:
    """
    Redimensiona a imagem para caber EXATAMENTE no tamanho alvo,
    mantendo a proporção original e adicionando bordas brancas se necessário.
    ...
    try:
        ...
        # Calcula o fator de escala para caber dentro do retângulo
        ...
        # Cria um canvas branco do tamanho exato
...
def add_photo_to_slide(slide, slot: dict, img_bytes: bytes):
    ...
    # Redimensionar (agora sem corte) e adicionar imagem
